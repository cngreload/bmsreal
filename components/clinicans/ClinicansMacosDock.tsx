...
import { LuHouse, LuSparkles, LuUsers, LuShieldCheck, LuRocket, LuChevronUp } from "react-icons/lu";
    ...
    useGSAP( () =>
    {
        ...
        ScrollTrigger.create( {
            ...
            onUpdate: ( self ) =>
            {
                ...
                {
                    gsap.to( dockWrapperRef.current, { y: 150, opacity: 0, duration: 0.4, ease: "power2.in" } );
        ...
        ScrollTrigger.create( {
            trigger: "footer",
            start: "top bottom",
            onEnter: () => gsap.to( dockWrapperRef.current, { y: 150, opacity: 0, duration: 0.3 } ),
        ...
        <div className="fixed bottom-6 md:bottom-10 left-1/2 -translate-x-1/2 z-[100] pointer-events-none">
            ...
            >
                ...
                <button
                    ...
                    className="group relative flex h-[44px] w-[44px] md:h-[54px] md:w-[54px] items-center justify-center rounded-xl md:rounded-2xl bg-slate-50 border border-slate-100 text-slate-400 hover:bg-[#10B981] hover:text-white transition-all duration-300 mb-0.5"
                >
    ...
    return (
        ...
        >
            ...
            <div className={ cn(
                ...
                isActive
                    ? "bg-gradient-to-br from-[#10B981] to-[#14B8A6] text-white border-[#10B981] shadow-lg shadow-emerald-500/30 scale-105"
